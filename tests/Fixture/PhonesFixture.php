...
class PhonesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'number' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-13 13:52:54',
            'modified' => '2016-11-13 13:52:54'
        ],
    ];
}
